...
func NewParamTable(typeU64End PIdx_U64, typeI64End PIdx_I64, typeF64End PIdx_F64, typeU32End PIdx_U32, typeI32End PIdx_I32, typeF32End PIdx_F32, typeU16End PIdx_U16, typeI16End PIdx_I16, typeU8End PIdx_U8, typeI8End PIdx_I8, typeBoolEnd PIdx_Bool, calcsCount PIdx_Calc) ParamTable {
	if typeU64End > PIdx_U64(typeI64End) || typeI64End > PIdx_I64(typeF64End) || typeF64End > PIdx_F64(typeU32End) ||
...
For an example template that fulfills this requirement, see the function body of 'paratable.TestParamTable(t *testing.T)' or the doc-comment of 'paratable.PARAM_TABLE_TEMPLATE_DOC_COMMENT'`)
	...
	var byteOffsets = [typeCount]uint32{
		...
		typeI32:  (uint32(typeF64End) * 8) + (uint32(PIdx_F64(typeU32End)-typeF64End) * 4),
		typeF32:  (uint32(typeF64End) * 8) + (uint32(PIdx_F64(typeI32End)-typeF64End) * 4),
		typeU16:  (uint32(typeF64End) * 8) + (uint32(PIdx_F64(typeF32End)-typeF64End) * 4),
		typeI16:  (uint32(typeF64End) * 8) + (uint32(PIdx_F64(typeF32End)-typeF64End) * 4) + (uint32(PIdx_F32(typeU16End)-typeF32End) * 2),
		typeU8:   (uint32(typeF64End) * 8) + (uint32(PIdx_F64(typeF32End)-typeF64End) * 4) + (uint32(PIdx_F32(typeI16End)-typeF32End) * 2),
